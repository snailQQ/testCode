...
//
//        34% Accepted
//        The code base version is an integer start from 1 to n. One day, someone committed a bad version in the code
// case, so it caused this version and the following versions are all failed in the unit tests.
